...
// /** Every block statement is plain block */
// class PlainBlock extends Solidity::BlockStatement {
//   PlainBlock() {
//       this = any(Solidity::BlockStatement ts)
//   }
// }

// /** XXX : This might be re-implemented later, hope not using */
// private predicate notBlankIdent(Solidity::AssignmentExpression ae) {
//   ae instanceof Solidity::AssignmentExpression and
//   ae.getLeft() instanceof Solidity::Identifier and
//   ae.getLeft().toString() != "_"
// }
 
//  /**
//   * Holds if `e` is a branch condition.
//   */
// private predicate isCondRoot(Solidity::AstNode e) {
//   e = any(Solidity::ForStatement fs).getCondition()
//   or
//   e = any(Solidity::IfStatement is).getCondition()
//   or
//   e = any(Solidity::DoWhileStatement dws).getCondition()
//   or
//   e = any(Solidity::WhileStatement ws).getCondition()
// }
